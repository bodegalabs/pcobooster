...
const DashboardPlanHeader = ({
  ...
  <header className={cn("mb-3 shrink-0 sm:mb-5", revealClassName)}>
...
export const DashboardPage = ({
  ...
  const headerRevealClassName = useRevealOnLoad(!hasSelectedPlanMetadata);
      ...
      >
        {hasSelectedPlanMetadata && selectedServiceType && selectedPlan ? (
          <DashboardPlanHeader
            ...
            revealClassName={headerRevealClassName}
          />
        ) : (
          <PlanHeaderSkeleton />
        )}
