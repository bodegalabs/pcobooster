...
- **Rate limits:** demo visitors share the token's Planning Center rate limit with anything else using that token. The existing read caches absorb repeated views.
