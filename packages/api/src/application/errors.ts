import type { AlreadyScheduled } from "@worship-admin/api/application/errors/already-scheduled";
...
import type { PositionMismatch } from "@worship-admin/api/application/errors/position-mismatch";
