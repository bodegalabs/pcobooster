import { serializedSongOptionSetSchema } from "@worship-admin/api/api-schemas";
import { hydrateSongOptionSet } from "@worship-admin/api/song-catalog-client";
import type { SerializedSongOptionSet } from "@worship-admin/api/song-catalog-client";
import type { SongOptionSet } from "@worship-admin/api/types";
import { z } from "zod";
