  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        treatment === "account" &&
          "border-border/60 shadow-overlay-shadow/35 gap-0 rounded-xl shadow-xl",
        className
      )}
      {...props}
    />
...
const DropdownMenuLabel = ({
  ...
  inset?: boolean;
  treatment?: "default" | "account" | "account-heading";
}) => (
  <DropdownMenuPrimitive.Label
    ...
    className={cn(
      ...
      treatment === "account" &&
        "text-muted-foreground px-2.5 pt-2 pb-1.5 text-xs",
      treatment === "account-heading" &&
        "rounded-none px-2.5 py-2.5 pb-2 font-normal",
      className
    )}
    {...props}
  />
